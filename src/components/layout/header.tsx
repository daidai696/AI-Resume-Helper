...
const NAV_ITEMS: { href: string; i18nKey: string; match: string; tourId?: string }[] = [
  ...
  { href: '/tracker', i18nKey: 'tracker.nav', match: '/tracker' },
  { href: '/industries', i18nKey: 'industries.nav', match: '/industries' },
  { href: '/collaboration', i18nKey: 'collaboration.nav', match: '/collaboration' },
